export const IPC = {
  ...
  reportExportPreflight: 'report:export-preflight',
  reportGenerationsList: 'report:generations-list',
  reportClaimsList: 'report:claims-list',
  deletionRetentionList: 'deletion-retention:list',
  deletionRetentionRetry: 'deletion-retention:retry',
